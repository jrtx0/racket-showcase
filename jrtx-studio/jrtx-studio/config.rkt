...
(current-locale-specifier 'jrtx-studio)
...
(current-option-name-prefix "JRTX_STUDIO")
...
(define-values (_ default-db-host default-db-port default-db-name default-db-username default-db-password)
  (parse-database-url (or (getenv "DATABASE_URL") "postgres://jrtx_studio:jrtx_studio@127.0.0.1:5432/jrtx_studio")))
...
(define-option test-db-name #:default "jrtx_studio_tests")
(define-option test-db-username #:default "jrtx_studio")
(define-option test-db-password #:default "jrtx_studio")
...
(define-option session-secret-key-path #:default "/tmp/jrtx-studio-secret-key")
...
(define-option product-name #:default "jrtx-studio")
(define-option company-name #:default "jrtx-studio")
(define-option company-address #:default "")
(define-option support-name #:default "Bot Botterson")
(define-option support-email #:default "support@jrtx-studio.com")
