...
Argo is a JSON Schema validator. Work with your JSON data knowing
that is adhere to some sensible constraints. If you have to work
with JSON, even if only occasionally, you may want to consider
